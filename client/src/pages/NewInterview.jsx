...
const NewInterview = () => {
  ...
  const { isBlocked, timeLeft, errorMessage, handleRateLimit } =
    useRateLimit("ai");
  ...
  const jobRoles = [
    {
      ...
      topic: "React, JavaScript, HTML, CSS, Tailwind",
    ...
    },
    {
      ...
      topic: "Node.js, Python, Java, SQL, APIs",
    ...
    },
    {
      ...
      topic: "React, Node.js, MongoDB, Express, SQL",
    ...
    },
    {
      ...
      topic: "SQL, NoSQL, PostgreSQL, MongoDB, Redis",
    ...
    },
    {
      ...
      topic: "Docker, Kubernetes, AWS, CI/CD, Linux",
    ...
    },
    {
      ...
      topic: "Python, TensorFlow, PyTorch, Scikit-learn, Pandas",
    ...
    },
    {
      ...
      icon: "📊",
      role: "Data Scientist",
      topic: "Python, SQL, Statistics, Pandas, NumPy, Matplotlib",
    ...
    },
    {
      ...
      icon: "📈",
      role: "Data Analyst",
      topic: "SQL, Excel, Tableau, Python, Power BI",
    ...
    },
    {
      ...
      topic: "React Native, Flutter, Swift, Kotlin",
    ...
    },
    {
      ...
      icon: "☁️",
      role: "Cloud Engineer",
      topic: "AWS, Azure, GCP, Terraform, Docker",
    ...
    },
    {
      ...
      topic: "Cybersecurity, Network Security, Penetration Testing",
    ...
    },
    {
      ...
      icon: "✅",
      role: "QA Engineer",
      topic: "Testing, Selenium, Jest, Cypress, Automation",
  ...
  const handleTopicAdd = (topicName) => {
    const currentTopics = formData.topic
      ? formData.topic.split(", ").map((t) => t.trim())
      : [];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const isRateLimited = handleRateLimit(error);

      // If not rate limited, show regular error
      if (!isRateLimited) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a2e] to-[#16213e] py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-slate-400 mb-8">
          Choose a role and topics to test your knowledge
        </p>
        ...
        {isBlocked && (
          <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-xl">
            <p className="text-red-400 text-center">
              ⚠️ {errorMessage} Please wait {timeLeft} before generating more
              questions.
            </p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
              {jobRoles.map((job) => (
                ...
                >
                  ...
                  <div
                    className={`text-sm font-medium ${formData.jobRole === job.role ? job.textColor : "text-white"}`}
                  >
                    {job.title}
                  </div>
                </button>
          ...
          <div className="glass-card p-6 rounded-xl">
            ...
            <input
              ...
              disabled={isBlocked}
              className="w-full px-4 py-3 bg-white/[0.06] border border-white/[0.08] rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500 disabled:opacity-50"
            />
          </div>
            ...
            <div className="flex flex-wrap gap-2 mb-4 max-h-40 overflow-y-auto">
              {topics.map((topic) => (
                <button
                  ...
                  disabled={isBlocked}
                  className={`px-3 py-1.5 rounded-lg border text-sm transition-all bg-gradient-to-br ${topic.color} ${topic.borderColor} ${topic.textColor} hover:scale-105 ${isBlocked ? "opacity-50 cursor-not-allowed" : ""}`}
                >
          ...
          <div className="glass-card p-6 rounded-xl">
            ...
            <select
              ...
              disabled={isBlocked}
              className="w-full px-4 py-3 bg-white border border-white/[0.08] rounded-lg text-black focus:outline-none focus:border-cyan-500 disabled:opacity-50"
            >
          ...
          <button
            type="submit"
            disabled={loading || isBlocked || !formData.jobRole}
        ...
        <div className="mt-8 p-4 bg-white/[0.03] rounded-xl border border-white/[0.08]">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              disabled={isBlocked}
              className="px-3 py-1 text-xs bg-white/[0.06] text-slate-300 rounded-full hover:bg-cyan-500/20 hover:text-cyan-400 transition-all disabled:opacity-50"
            >
              Frontend Quiz
            </button>
            <button
